...
kick_mml.score("Q4 L4 O1 G!G!G!G! G!G!G!G! G!G8.!G16G!G! G!G!G!G8!G8", undefined, true);
...
bass_mml.score("Q5 L16 O1 F!>C<FC F!~>E8!~<C F>C!<FC~ FRF8", undefined, true);
...
var sc = (note: string, repeat: number = 1) => `RR${note}${note}!RR${note}${note}!RR${note}${note}!RR${note}${note}!`.repeat(repeat);
synth_mml[0].score(`Q4 L16 O5 | ${sc("C", 4) + sc("C", 2) + sc("C", 2)}`, undefined, true);
synth_mml[1].score(`Q4 L16 O4 | ${sc("G", 4) + sc("A", 2) + sc("F", 2)}`, undefined, true);
synth_mml[2].score(`Q4 L16 O4 | ${sc("F", 4) + sc("E", 2) + sc("D", 2)}`, undefined, true);
